...
from .title_caption_links import title_caption_links
...
from .context_strings import name

from .context_dictionaries import contact_dict, profile_dict, work_experience_dict, achievements_dict, skills_dict, education_dict